...
If you are creating a new directory, be sure to create a README. Describe the purpose of each directory in one or two sentences, but environment setup should be documented in detail.
